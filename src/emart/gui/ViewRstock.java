...
public class ViewRstock extends javax.swing.JFrame {
   ...
   DefaultTableModel tm;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewRstock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewRstock().setVisible(true);
            }
        });
    }
