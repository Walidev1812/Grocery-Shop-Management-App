...
public class Updateitem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Update Item Panel");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add Item", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 22), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(oprice, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(51, 51, 51))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(nam, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(quan, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private boolean validateInputs()
    {
        return !(nam.getText().isEmpty() || price.getText().isEmpty() || oprice.getText().isEmpty() || com.getText().isEmpty() || quan.getText().isEmpty());
    }
    ...
    private void tab1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab1MouseClicked
        ...
        id.setText(tm.getValueAt(row,0).toString());
        nam.setText(tm.getValueAt(row,1).toString());
        com.setText(tm.getValueAt(row,2).toString());
        price.setText(tm.getValueAt(row,3).toString());
        oprice.setText(tm.getValueAt(row,4).toString());
        quan.setText(tm.getValueAt(row,5).toString());
        String  tx=tm.getValueAt(row, 6).toString();
        tax.setSelectedItem(tx);
    ...
    private void upActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upActionPerformed
      ...
      try{
          ...
          int x=tax.getSelectedItem().toString().length();
          int taxe=Integer.parseInt(tax.getSelectedItem().toString().substring(0,x-1));
          p.setTax(taxe);
